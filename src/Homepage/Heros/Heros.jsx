...
const Heros = () => {
  const donors = [
    { name: "Nafiz", group: "O+", img: "https://i.ibb.co/2Y3sqbt3/profile-1.jpg", quote: "Donating blood gives me purpose." },
    { name: "Farhan Ahmed", group: "A-", img: "https://i.ibb.co/s91DSJJr/charlie-green-3-Jmf-ENc-L24-M-unsplash-1.jpg", quote: "I feel honored knowing my blood might save someone." },
    { name: "Hasan Kabir", group: "B+", img: "https://i.ibb.co/F4nq0bkn/ana-nichita-BI91-Nrpp-E38-unsplash-1.jpg", quote: "BloodAid makes it easy to connect and help." },
    { name: "Ayesha Rahman", group: "AB+", img: "https://i.ibb.co/0GKPn6k/profile-2.jpg", quote: "Every drop of blood is a lifeline." },
  ];
